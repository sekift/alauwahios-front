package cn.alauwahios.front.redis.jedis;
...
import cn.alauwahios.front.locate.HashAlgorithms;
import cn.alauwahios.front.locate.NodeLocator;
import cn.alauwahios.front.locate.NodeLocators;
import cn.alauwahios.front.locate.NodeLocators.ConsistentHashLocator;
import cn.alauwahios.front.redis.RedisPoolConfig;
import cn.alauwahios.front.redis.RedisPoolService;
import cn.alauwahios.front.redis.mbean.Fw;
import cn.alauwahios.front.redis.mbean.RedisHealthCheck;
import cn.alauwahios.front.util.JMXUtil;
	...
	public static void returnBrokenResourceSilently(JedisPool jp, Jedis r) {
		if (null != jp && null != r) {
			try {
				...
				logger.error("JedisPool回收资源失败:", e);
			}
			r = null;
		}
	}
