 ...
 *
 */
public class WangzhiDaohangVO implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -8769590280557263671L;
	private int id;	  //`id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
	private String fxName;	//`fxName` varchar(500) DEFAULT '' COMMENT '名字',
	private String fxLink;	//`fxLink` varchar(500) DEFAULT '' COMMENT '链接',
